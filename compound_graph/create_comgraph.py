...
graph_json = open('graph_attrs/compound_dot_graphgpt.json', 'r')
class_json = open('graph_attrs/mml-classification_named.json', 'r')
...
with open('graph_attrs/graph_class_named.json', 'w') as f :
